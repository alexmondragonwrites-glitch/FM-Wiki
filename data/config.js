(()=>{
  const config={
    schemaVersion:2,
    referenceDate:'2041-10-08',
    currentSeason:2041,
    nextSeason:2042,
    updatedAt:'2041-10-08',
    locale:'de-DE',
    ...
    navigation:[
      ...
      {id:'players',label:'Spieler',href:'spieler.html?id=diego-fernandez'},
      {id:'ireland',label:'Nationalteam',href:'nationalteam.html'},
      {id:'season',label:'Saison',href:'saison.html'},
      {id:'matches',label:'Spiele',href:'spiele.html'},
      {id:'clubs',label:'Klubs',href:'klubs.html'},
      {id:'press',label:'Presse',href:'presse.html?id=2041-10-08-finn-harps-laenderspielueberblick'},
