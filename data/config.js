(()=>{
  const config={
    schemaVersion:2,
    referenceDate:'2042-09-08',
    currentSeason:2042,
    nextSeason:2043,
    updatedAt:'2042-09-08',
    locale:'de-DE',
    siteName:'Finn Harps FM Wiki',
    dataDates:Object.freeze({players:'2042-09-08',transfers:'2042-08-31',nationalTeam:'2042-07-20',clubs:'2042-09-08',matches:'2042-09-05',season:'2042-09-08',news:'2042-09-08',staff:'2041-06-17'}),
    navigation:[
      ...
      {id:'press',label:'Presse',href:'presse.html?id=2042-09-08-inter-champions-league-preview'},
