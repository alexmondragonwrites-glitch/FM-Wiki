(()=>{
  const config={
    schemaVersion:2,
    referenceDate:'2042-07-25',
    currentSeason:2042,
    nextSeason:2043,
    updatedAt:'2042-07-25',
    locale:'de-DE',
    siteName:'Finn Harps FM Wiki',
    dataDates:Object.freeze({players:'2042-07-25',transfers:'2042-07-18',nationalTeam:'2042-07-20',clubs:'2042-07-25',matches:'2042-07-25',season:'2042-07-25',news:'2042-07-25',staff:'2041-06-17'}),
    navigation:[
      ...
      {id:'press',label:'Presse',href:'presse.html?id=2042-07-25-derry-city-finn-harps-1-4-post-world-cup-return'},
