(()=>{
  const config={
    schemaVersion:2,
    referenceDate:'2042-08-01',
    currentSeason:2042,
    nextSeason:2043,
    updatedAt:'2042-08-01',
    locale:'de-DE',
    siteName:'Finn Harps FM Wiki',
    dataDates:Object.freeze({players:'2042-08-01',transfers:'2042-07-18',nationalTeam:'2042-07-20',clubs:'2042-08-01',matches:'2042-08-01',season:'2042-08-01',news:'2042-08-01',staff:'2041-06-17'}),
    navigation:[
      ...
      {id:'press',label:'Presse',href:'presse.html?id=2042-08-01-finn-harps-sligo-rovers-2-0-total-control'},
