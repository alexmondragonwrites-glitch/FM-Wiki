(()=>{
  const config={
    schemaVersion:2,
    referenceDate:'2042-06-12',
    currentSeason:2042,
    nextSeason:2043,
    updatedAt:'2042-06-12',
    locale:'de-DE',
    siteName:'Finn Harps FM Wiki',
    dataDates:Object.freeze({
      players:'2042-06-12',
      transfers:'2042-02-22',
      nationalTeam:'2042-06-12',
      clubs:'2042-05-31',
      matches:'2042-06-07',
      season:'2042-05-31',
      news:'2042-06-12',
    ...
    navigation:[
      ...
      {id:'players',label:'Spieler',href:'spieler.html?id=dom-docherty'},
      {id:'ireland',label:'Nationalteam',href:'nationalteam.html'},
      {id:'season',label:'Saison',href:'saison.html'},
      {id:'matches',label:'Spiele',href:'spiele.html'},
      {id:'clubs',label:'Klubs',href:'klubs.html'},
      {id:'press',label:'Presse',href:'presse.html?id=2042-06-12-world-cup-opening-day-groups-a-c'},
