(()=>{
  ...
  add('players',[...recentResults,redBullSalzburgResult,stPatricksOctoberResult,waterfordOctoberResult,derryCityOctoberResult,derryCitySeasonFinale,jackCahillProfile,internationalCallups,youngBoysResult,irelandAzerbaijanResult,irelandCyprusFinalResult,internationalDutyNovember,barcelonaResult]);
  add('nationalTeam',[internationalCallups,irelandAzerbaijanResult,irelandCyprusFinalResult]);
  add('matches',[...recentResults,redBullSalzburgResult,stPatricksOctoberResult,waterfordOctoberResult,derryCityOctoberResult,derryCitySeasonFinale,youngBoysResult,faiCupFinal,irelandAzerbaijanResult,irelandCyprusFinalResult,barcelonaResult]);
  add('fixtures',[...recentResults,redBullSalzburgResult,stPatricksOctoberResult,waterfordOctoberResult,derryCityOctoberResult,derryCitySeasonFinale,youngBoysResult,faiCupFinal,irelandAzerbaijanResult,irelandCyprusFinalResult,barcelonaResult]);
  add('clubs',[...recentResults,manUnitedPreview,redBullSalzburgPreview,redBullSalzburgResult,youngBoysPreview,youngBoysResult,barcelonaResult,realSociedadPreview]);
  ...
  add('league',[...recentResults,championsLeagueMatchdayThreeTuesday,redBullSalzburgResult,stPatricksOctoberResult,waterfordOctoberResult,derryCityOctoberResult,derryCitySeasonFinale,irishLeaguesSeasonSummary,youngBoysResult,faiCupFinal,barcelonaResult]);
