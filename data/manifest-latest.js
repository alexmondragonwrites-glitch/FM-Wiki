(()=>{
  ...
  const premierDivisionTvDeal2042='data/premier-division-tv-deal-2042-02-09.js';
  const shamrockLeagueOpener2042='data/shamrock-rovers-result-2042-02-14.js';
  const waterfordLeague2042='data/waterford-result-2042-02-18.js';
  const varmaTransfer2042='data/player-graham-varma-transfer-bournemouth-2042-02-22.js';
  const championsLeagueRound16Draw2042='data/champions-league-round-of-16-draw-2042-02-24.js';
  const stPatricksFebruary2042='data/st-patricks-result-2042-02-28.js';
  const caenClubWorldCupHistory2042='data/caen-club-world-cup-history-2042-03-02.js';
  const caenRound16FirstLeg2042='data/caen-finn-harps-result-2042-03-05.js';
  const escarcegaAgeCorrection2042='data/escarcega-age-correction-2042-03-05.js';
  const corkCityMarch2042='data/cork-city-result-2042-03-08.js';
  const caenRound16SecondLeg2042='data/finn-harps-caen-result-2042-03-11.js';
  const sligoMarch2042='data/sligo-rovers-result-2042-03-14.js';
  const benBarryMarch2042='data/player-ben-barry-update-2042-03-18.js';
  const athloneMarch2042='data/athlone-town-result-2042-03-18.js';

  add('players',[...recentResults,redBullSalzburgResult,stPatricksOctoberResult,waterfordOctoberResult,derryCityOctoberResult,derryCitySeasonFinale,jackCahillProfile,internationalCallups,youngBoysResult,irelandAzerbaijanResult,irelandCyprusFinalResult,internationalDutyNovember,barcelonaResult,realSociedadResult,torricBruceContract,openingSquad2042,brazilFinalissimaResult,ferreiraLoan2042,rouviereTransfer2042,anderlechtResult2042,aekResult2042,raulTarget2042,raulConfirmed2042,raulPressFollowup2042,presidentsCupDerry2042,shamrockLeagueOpener2042,waterfordLeague2042,varmaTransfer2042,stPatricksFebruary2042,caenRound16FirstLeg2042,escarcegaAgeCorrection2042,corkCityMarch2042,caenRound16SecondLeg2042,sligoMarch2042,benBarryMarch2042,athloneMarch2042]);
