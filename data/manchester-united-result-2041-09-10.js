(()=>{
  ...
  const match={
    ...
    scorers:[
      {player:'Cormac O’Kane',team:'Finn Harps',goals:1,minutes:[78]}
    ],
    events:[
      {minute:78,type:'goal',team:'Finn Harps',player:'Cormac O’Kane',text:'1:0'}
    ],
    stats:[
    ...
    playerRatings:{
      'Paulo Henrique':7.3,'Diego Fernández':7.1,'Torric Bruce':7.3,'Darcy Andrews':7.2,'Kevin Kelly':7.2,'Jim O’Neill':6.6,
      'Daryl Frame':6.8,'Cormac O’Kane':8.8,'Giacomo Papini':6.9,'Dom Docherty':6.7,'Emerson Escárcega':6.7,'Billy Walker':7.0,
      'Callum Brennan':6.8,'Romano Maisto':6.7,'Amir Mašić':6.7,'Justin Ramsey':6.7
    },
    milestones:[
  ...
  const report={
    id:reportId,type:'Spielbericht',date:'2041-09-10',competition:'UEFA Champions League',fixtureDate:'Mittwoch, 10.09.2041',
    home:'Finn Harps',away:'Manchester United',score:'1:0',location:'Donegal Stadium · Ligaphase, 1. Spieltag · 10.000 Zuschauer',
  ...
  upsert(window.FM_NEWS,{
    id:'2041-09-10-manchester-united-result',date:'2041-09-10',season:2041,category:'Champions League',accent:'gold',featured:true,
    eyebrow:'CHAMPIONS LEAGUE · LIGAPHASE · FINN HARPS 1:0 MANCHESTER UNITED',
    title:'Revanche geglückt: O’Kane schießt United aus Donegal',
    summary:'Cormac O’Kane trifft in der 78. Minute. Finn Harps kontrolliert Manchester United mit 17:4 Schüssen, 12:2 aufs Tor und 2,26:0,48 xG und eröffnet die Ligaphase mit drei Punkten.',
    href:`presse.html?id=${reportId}`,
    entities:['finn-harps','man-utd','cormac-okane','emerson-escarcega','ricardo-lopez','champions-league-2041','season-2041']
  });
})();